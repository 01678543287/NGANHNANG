...
namespace QUANLYNGANHANG
{
    static class Program
    {
        ...
        public static String StrConn_ServerPublisher = "Data Source=DESKTOP-ICQJDEE;Initial Catalog=NGANHANG;Persist Security Info=True;User ID=sa;Password=123"; // chuỗi kết nối tới server chủ_ Với máy nào thì thay đổi chuổi kết nối này lại
